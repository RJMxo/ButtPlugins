...
public enum CraftingMethods {
    ...
    Cut_Opal(ItemID.UNCUT_OPAL, ItemID.CHISEL, ItemID.OPAL, 17694734, ItemID.CRUSHED_GEM),
    Cut_Topaz(ItemID.UNCUT_RED_TOPAZ, ItemID.CHISEL, ItemID.RED_TOPAZ, 17694734, ItemID.CRUSHED_GEM),
    Cut_Jade(ItemID.UNCUT_JADE, ItemID.CHISEL, ItemID.JADE, 17694734, ItemID.CRUSHED_GEM),
    Cut_Sapphire(ItemID.UNCUT_SAPPHIRE, ItemID.CHISEL, ItemID.SAPPHIRE, 17694734, ItemID.CRUSHED_GEM),
    Cut_Ruby(ItemID.UNCUT_RUBY, ItemID.CHISEL, ItemID.RUBY, 17694734, ItemID.CRUSHED_GEM),
    Cut_Emerald(ItemID.UNCUT_EMERALD, ItemID.CHISEL, ItemID.EMERALD, 17694734, ItemID.CRUSHED_GEM),
    Cut_Diamond(ItemID.UNCUT_DIAMOND, ItemID.CHISEL, ItemID.DIAMOND, 17694734, ItemID.CRUSHED_GEM),
